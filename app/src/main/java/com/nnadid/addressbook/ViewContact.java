...
public class ViewContact extends Activity 
{
   ...
   public void onCreate(Bundle savedInstanceState) 
   {
      ...
      rowID = extras.getLong(splash.ROW_ID);
   } // end method onCreate
   ...
   public boolean onOptionsItemSelected(MenuItem item) 
   {
      switch (item.getItemId()) // switch based on selected MenuItem's ID
      {
         case R.id.editItem:
            ...
            addEditContact.putExtra(splash.ROW_ID, rowID);
         ...
         case R.id.deleteItem:
            ...
            return true;
          case R.id.call:
         //Intent inte = new Intent(this,ViewContact.class);
              //inte.putExtra(splash.ROW_ID,rowID);
            Uri phoneur =Uri.parse("tel:"+phoneTextView.getText());
            new Intent(Intent.ACTION_DIAL,phoneur);
              //startActivity(inte);
             // return true;
         default:
