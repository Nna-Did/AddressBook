...
/**
 * Created by Nna-Did on 6/13/2015.
 */
public class splash extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        contactAdapter = new SimpleCursorAdapter(
                splash.this, R.layout.contact_list_item, null, from, to);
    ...
    private class GetContactsTask extends AsyncTask<Object, Object, Cursor>
    {
        DatabaseConnector databaseConnector =
                new DatabaseConnector(splash.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        Intent addNewContact =
                new Intent(splash.this, AddEditContact.class);
    ...
    AdapterView.OnItemClickListener viewContactListener = new AdapterView.OnItemClickListener()
    {
                                ...
                                long arg3)
        {
            ...
            Intent viewContact = new Intent(splash.this, ViewContact.class);
